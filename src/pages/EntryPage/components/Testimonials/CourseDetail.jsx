...
const testimonials = [
  {
    name: "Aysel H.",
    text: "Bu kurslar sayəsində dövlət qulluğuna qəbul oldum!",
  },
  {
    name: "Elvin M.",
    text: "Tədris keyfiyyəti çox yüksək və müəllimlər peşəkardır.",
  },
];

export default function CourseDetail({fadeInUp}) {
  return (
    <div className="max-w-6xl mx-auto px-4 m-10">
    
    <motion.section
          className="mt-24 py-16 bg-gradient-to-r from-blue-100 via-white to-blue-100 rounded-2xl shadow-xl"
          variants={fadeInUp}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
        >
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10 items-start">
            <div className="md:col-span-1 text-left">
              <h2 className="text-3xl font-bold  mb-4" style={{color:"#1B2070"}}>Təcrübə və Etibar ilə Yol Göstəririk</h2>
              <p className="text-gray-700">
                Dövlət Tədris Mərkəzi olaraq missiyamız Azərbaycan gənclərinə dövlət və mühasibatlıq sahələrində peşəkar və praktiki biliklər qazandırmaqdır.
                Təcrübəli müəllim heyətimiz, innovativ yanaşmalar və yüksək keyfiyyətli tədris metodlarımızla fərq yaradırıq.
              </p>
            </div>
